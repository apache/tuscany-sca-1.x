...
/**
 * Tests the Currency Converter Web Service Binding scenario
 */
public class NodeTestCase {
    ...
    public void startServer() throws Exception {
        node = SCANodeFactory.newInstance().createSCANode("currency-converter-ws.composite", 
            new SCAContribution("currency", "../../contributions/currency-contribution/target/classes"),
            new SCAContribution("currency-ws", "../../contributions/currency-contribution-ws/target/classes"));
        node.start();
    }
