...
public class Sample2Client {
    ...
    public static String invoke(String in) throws ConfigurationException {
        ...
        TuscanyRuntime tuscany = new TuscanyRuntime("sample1", null);
    ...
    public static String invokeDeutsch(String in) throws ConfigurationException {
        ...
        // Locate the German HelloWorld service component and invoke it
        HelloWorld helloworldService = (HelloWorld) moduleContext.locateService("HelloWorldComponentDeutsch");
