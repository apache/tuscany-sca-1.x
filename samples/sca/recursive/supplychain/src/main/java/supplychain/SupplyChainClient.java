...
public class SupplyChainClient {
    ...
    public static final void main(String[] args) throws Exception {
        ...
        TuscanyRuntime tuscany = new TuscanyRuntime("SupplyChainSample", "supplychain", monitorFactory);

        // Associate the application module component with this thread
        tuscany.start();

        // Obtain SCA composite context.
        CompositeContext compositeContext = CurrentCompositeContext.getContext();

        // Locate the HelloWorld service component and invoke it
        Customer customer = compositeContext.locateService(Customer.class, "CustomerComponent");
