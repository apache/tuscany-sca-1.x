...
public class CustomerInfoClient {
    ...
    public static final void main(String[] args) throws Exception {
        ...
        TuscanyRuntime tuscany = new TuscanyRuntime("CustomerInfoSample", "customerinfo", monitorFactory);
        ...
        Object customerInfoService = compositeContext.locateService(Object.class, "CustomerInfoServiceComponent");
